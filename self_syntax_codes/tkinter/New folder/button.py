...
def install_sql(s_name,u_name,passwd):
	...
	#print stderr.readlines()
	#p.terminate()
	tk.Label(window2,text="SQL DB has been successfully installed.").grid()
...
def hello_world3():
	...
	window1.geometry("440x410")
	#frame3=tk.Frame(window1,bd=5)
	label=tk.Label(window1,text='Please upload the request form(ini) file in "C:\\MdbBOT\\SQL\\config folder"\n\n And click on Proceed to continue\n\n')
	label.pack()
