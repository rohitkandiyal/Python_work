...
def patch_oracle(s_name,u_name,passwd):
	...
	stdin, stdout, stderr = a.exec_command("mv /u001/app/oracle/product/12.1.0.2/db_1/OPatch /u001/app/oracle/product/12.1.0.2/db_1/OPatch_old", get_pty=True)
	print stderr.readlines()
	print stdout.readlines()
	stdin, stdout, stderr = a.exec_command("cd /u001/app/oracle/product/12.1.0.2/db_1 && unzip /u01/PATCH/p6880880_122010_Linux-x86-64.zip", get_pty=True)
	print stderr.readlines()
	print stdout.readlines()
	stdin, stdout, stderr = a.exec_command("cd /u001/app/oracle/product/12.1.0.2/db_1/OPatch && unzip /u01/PATCH/p26550023_121020_Linux-x86-64.zip", get_pty=True)
	print stderr.readlines()
	print stdout.readlines()
